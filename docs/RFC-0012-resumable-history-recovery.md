...
Статус: реализовано в M0.7.9; многостраничная сессия добавлена в M0.9.1
Дата: 2026-09-01
...
Продолжение этого исторического контракта реализовано в
[`RFC-0028`](RFC-0028-bounded-multi-page-history-recovery-session.md): до 64
смежных страниц теперь передаются по одному явно подтверждённому connection,
при этом checkpoint и atomic per-page commit остаются неизменными.
