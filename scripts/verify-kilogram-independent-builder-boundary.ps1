...
foreach ($required in @(
    ...
    'Get-KilogramCargoRegistrySourceRoot',
    ...
    'Assert-KilogramPeCanonicalPathRemapping',
    '-CargoRegistrySourceRoot $cargoRegistrySourceRoot',
    'format_version = 6',
    'cargo_registry_source_root = $pathRemap.cargo_registry_source_root',
...
foreach ($required in @(
    ...
    'host_cargo_registry_path=rejected',
